...
<body>
  ...
  <!--Note: Adding new "news and event" must change the code statically-->
		...
		<div class="col-lg-12"></div>
  		<li><h3 class="h2-line">November 1</h3></li>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Data from Database</h4>
              </div>
            
              <div class="modal-body">
                <div class="form-group">
                    <div style="background-: url(images/pic3.jpg);"></div>
        				    <p class="text-center">Data from Database Data from Database Data from DatabaseData from Database DataData from Database Data from Database Data from Database Data from Database</p>
  			...
  			<li><h3 class="h2-line">November 2 2014</h3></li>
        ...
        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Data from Database data</h4>
              </div>
              ...
              <div class="modal-footer"></div>
				...
				<li><h3 class="h2-line">November 10 2014</h3></li>
          ...
          <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
            <div class="modal-dialog">
              <div class="modal-content">
				...
				<li><h3 class="h2-line">November 11</h3></li>
        <div class="col-8 col-lg-9">
					<div style="float:left" padding:"10px" width:"50px"><img src="favicon.png"/></div>
					<h4>Anouncements here! Anouncements here!. Anouncements here! Anouncements here!</h4>
        ...
        <div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
          <div class="modal-dialog">
		    ...
		    <li><h3 class="h2-line">November 22</h3></li>
          <div class="col-8 col-lg-9">
            <div style="float:left" padding:"10px" width:"50px"><img src="favicon.png"/></div>
						<h4>Anouncements here! Anouncements here!. Anouncements here! Anouncements here!</h4>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer"></div>
				...
				<li><h3 class="h2-line">November 30</h3></li>
				  <div class="col-8 col-lg-9">
            <div style="float:left" padding:"10px" width:"50px"><img src="favicon.png"/></div>
						<h4>Anouncements here! Anouncements here!. Anouncements here! Anouncements here!</h4>
		...
		<li><h3 class="h2-line">November 30</h3></li>
            ...
            <div style="float:left" padding:"10px" width:"50px"><img src="favicon.png"/></div>
						<h4>Anouncements here! Anouncements here!. Anouncements here! Anouncements here!</h4>
						<a class="ca-more" href="#" data-toggle="modal" data-target="#myModal7">more...</a>
					</div>
		...
		<li><h3 class="h2-line">November 30</h3></li>
            ...
            <div style="float:left" padding:"10px" width:"50px"><img src="favicon.png"/></div>
						<h4>Anouncements here! Anouncements here!. Anouncements here! Anouncements here!</h4>
						<a class="ca-more" href="#" data-toggle="modal" data-target="#myModal8">more...</a>
					</div>
