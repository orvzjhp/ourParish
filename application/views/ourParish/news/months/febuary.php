...
<body>
	...
	<div class="container">
		...
		<div class="col-lg-12"></div>
  		<li><h3 class="h2-line">February 1</h3></li>
        ...
        <div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
          <div class="modal-dialog">
            <div class="modal-content">
  			...
  			<li><h3 class="h2-line">February 2 2014</h3></li>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer"></div>
				...
				<li><h3 class="h2-line">February 10 2014</h3></li>
          ...
          <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
            <div class="modal-dialog">
              <div class="modal-content">
				...
				<li><h3 class="h2-line">February 11</h3></li>
        <div class="col-8 col-lg-9">
					<div style="float:left" padding:"10px" width:"50px"><img src="<?php echo base_url(); ?>html_attrib/parishStyles/month/favicon.png"/></div>
					<h4>Anouncements here! Anouncements here!. Anouncements here! Anouncements here!</h4>
        ...
        <div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
          <div class="modal-dialog">
		    ...
		    <li><h3 class="h2-line">February 22</h3></li>
          <div class="col-8 col-lg-9">
            <div style="float:left" padding:"10px" width:"50px"><img src="<?php echo base_url(); ?>html_attrib/parishStyles/month/favicon.png"/></div>
						<h4>Anouncements here! Anouncements here!. Anouncements here! Anouncements here!</h4>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer"></div>
				...
				<li><h3 class="h2-line">February 30</h3></li>
				  <div class="col-8 col-lg-9">
            <div style="float:left" padding:"10px" width:"50px"><img src="<?php echo base_url(); ?>html_attrib/parishStyles/month/favicon.png"/></div>
						<h4>Anouncements here! Anouncements here!. Anouncements here! Anouncements here!</h4>
